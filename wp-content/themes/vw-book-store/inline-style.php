<?php
	...
	if($vw_book_store_sticky_header_padding != false){
		$vw_book_store_custom_css .='.header-fixed{';
			$vw_book_store_custom_css .='padding: '.esc_html($vw_book_store_sticky_header_padding).';';
		$vw_book_store_custom_css .='}';
	}
	...
	if($vw_book_store_social_icon_font_size != false){
		$vw_book_store_custom_css .='#sidebar .custom-social-icons i, #footer .custom-social-icons i{';
			$vw_book_store_custom_css .='font-size: '.esc_html($vw_book_store_social_icon_font_size).';';
		$vw_book_store_custom_css .='}';
	}
	...
	if($vw_book_store_social_icon_padding != false){
		$vw_book_store_custom_css .='#sidebar .custom-social-icons i, #footer .custom-social-icons i{';
			$vw_book_store_custom_css .='padding: '.esc_html($vw_book_store_social_icon_padding).';';
		$vw_book_store_custom_css .='}';
	}
	...
	if($vw_book_store_social_icon_width != false){
		$vw_book_store_custom_css .='#sidebar .custom-social-icons i, #footer .custom-social-icons i{';
			$vw_book_store_custom_css .='width: '.esc_html($vw_book_store_social_icon_width).';';
		$vw_book_store_custom_css .='}';
	}
	...
	if($vw_book_store_social_icon_height != false){
		$vw_book_store_custom_css .='#sidebar .custom-social-icons i, #footer .custom-social-icons i{';
			$vw_book_store_custom_css .='height: '.esc_html($vw_book_store_social_icon_height).';';
		$vw_book_store_custom_css .='}';
	}
	...
	if($vw_book_store_social_icon_border_radius != false){
		$vw_book_store_custom_css .='#sidebar .custom-social-icons i, #footer .custom-social-icons i{';
			$vw_book_store_custom_css .='border-radius: '.esc_html($vw_book_store_social_icon_border_radius).'px;';
		$vw_book_store_custom_css .='}';
	}
	...
	if($vw_book_store_products_padding_top_bottom != false){
		$vw_book_store_custom_css .='.woocommerce ul.products li.product, .woocommerce-page ul.products li.product{';
			$vw_book_store_custom_css .='padding-top: '.esc_html($vw_book_store_products_padding_top_bottom).'!important; padding-bottom: '.esc_html($vw_book_store_products_padding_top_bottom).'!important;';
		$vw_book_store_custom_css .='}';
	}
	...
	if($vw_book_store_products_padding_left_right != false){
		$vw_book_store_custom_css .='.woocommerce ul.products li.product, .woocommerce-page ul.products li.product{';
			$vw_book_store_custom_css .='padding-left: '.esc_html($vw_book_store_products_padding_left_right).'!important; padding-right: '.esc_html($vw_book_store_products_padding_left_right).'!important;';
		$vw_book_store_custom_css .='}';
	}
	...
	if($vw_book_store_products_box_shadow != false){
		$vw_book_store_custom_css .='.woocommerce ul.products li.product, .woocommerce-page ul.products li.product{';
				$vw_book_store_custom_css .='box-shadow: '.esc_html($vw_book_store_products_box_shadow).'px '.esc_html($vw_book_store_products_box_shadow).'px '.esc_html($vw_book_store_products_box_shadow).'px #ddd;';
		$vw_book_store_custom_css .='}';
	}
	...
	if($vw_book_store_products_border_radius != false){
		$vw_book_store_custom_css .='.woocommerce ul.products li.product, .woocommerce-page ul.products li.product{';
			$vw_book_store_custom_css .='border-radius: '.esc_html($vw_book_store_products_border_radius).'px;';
		$vw_book_store_custom_css .='}';
	}